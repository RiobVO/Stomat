...
- 11.06.2026 БАТЧ «ПОЛИРОВКА-2» ЗАКРЫТ ЦЕЛИКОМ (subagent-driven: свежий
  ...
  СЛЕДУЮЩИЙ ШАГ: по решению пользователя — живой тык новых поверхностей
  (кнопка call_admin, «ℹ️ О клинике», /stats с кнопками) и/или батч
  «витрина для покупателя»; пилот Ф2 — строго по явной команде.
