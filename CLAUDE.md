...
- 11.06.2026 БАТЧ «ПОЛИРОВКА ДИАЛОГА + ВИТРИНА» ЗАКРЫТ ЦЕЛИКОМ
  ...
  П-1 (6be5bd4): детектор наличия (контекст ИЛИ словарь ru/uz,
  dialog_common.mentions_availability) → выбор дня, не эскалация;
  П-2а (ce38137): 🔴 эскалация ТОЛЬКО по прямой просьбе человека
  ...
  П-2б (d93494f): FAQ-слой без LLM — часы работы (open_bounds) и адрес
  ...
  П-6 (2b8e5ab): /stats [7|30] — владельческий рендер (💰 Ценность:
...
- 11.06.2026 вечер: ЖИВОЙ ТЫК ПОЛЬЗОВАТЕЛЯ → три правки по горячим следам:
  ...
  «Другое время» (a900673);
  П-5б (163b4fb): месячная эмодзи-сетка «очень тупо» → ВЫБРОШЕНА,
  ...
  П-7 (e8c6903): «визуал очень нудно» → стиль маникюр-бота: parse_mode
