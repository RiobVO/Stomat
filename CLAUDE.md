...
- СЛЕДУЮЩИЙ ШАГ: обязательной инженерной работы НЕТ. В PILOT_HARDENING
  открыты только гейтящиеся решением/деньгами: m2 (book↔question — реальный
  сет с пилота), m4 (граница «вечера» — product-решение), P4 T1/T2 (NLU-
  eval / Gemini-failover — платные LLM-вызовы). Ждать явной команды
