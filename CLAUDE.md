...
- Остановились 07.06.2026: кодовая часть Ф1.5 закрыта и запушена, 308
  тестов зелёные. Пункт «юрист по ПД» СНЯТ решением пользователя
  07.06.2026 — тему не поднимать; docs/PRIVACY.md остаётся как
  инженерная карта данных.
...
- Дальше только по входу пользователя: правки носителя
...
- Ф1.5 Production-Ready v1.0: КОДОВАЯ ЧАСТЬ ЗАКРЫТА 07.06.2026 — группы A
  ...
  Детали — чекбоксы BRIEF разд. 14. Осталось ВНЕШНЕЕ: D.4 узбекские
  строки replies.py носителем; группа C — строго по явной команде
  пользователя. D.1 (юрист по ПД) СНЯТ решением пользователя 07.06.2026.
