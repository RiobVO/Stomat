...
- 11.06.2026 БАТЧ «ПОЛИРОВКА ДИАЛОГА + ВИТРИНА» ЗАКРЫТ ЦЕЛИКОМ
  ...
  П-1 (45bd9f3): детектор наличия (контекст ИЛИ словарь ru/uz,
  dialog_common.mentions_availability) → выбор дня, не эскалация;
  П-2а (4fcfdbf): 🔴 эскалация ТОЛЬКО по прямой просьбе человека
  ...
  П-2б (4ae62d6): FAQ-слой без LLM — часы работы (open_bounds) и адрес
  ...
  П-6 (b5f3e46): /stats [7|30] — владельческий рендер (💰 Ценность:
...
- 11.06.2026 вечер: ЖИВОЙ ТЫК ПОЛЬЗОВАТЕЛЯ → три правки по горячим следам:
  ...
  «Другое время» (a179e29);
  П-5б (d242427): месячная эмодзи-сетка «очень тупо» → ВЫБРОШЕНА,
  ...
  П-7 (8574f37): «визуал очень нудно» → стиль маникюр-бота: parse_mode
...
- Рабочие заметки: Docker Desktop может быть выключен — стартануть и
