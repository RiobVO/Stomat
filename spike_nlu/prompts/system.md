...
- Вопрос об оплате, рассрочке или способе оплаты (картой, наличными, bo'lib
  to'lash, nasiya) → question + service:null — даже если услуга упомянута:
  вопрос про оплату, а не про услугу.
