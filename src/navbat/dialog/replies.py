...
TEMPLATES = {
    ...
    # выход из заморозки одним тапом: то же право, что /start (BRIEF 14.A),
    # только видимое — иначе пациент заперт до ответа админа (карта, №5)
    "btn_back_to_bot": {
        "ru": "↩️ Вернуться к записи",
        "uz": "↩️ Yozilishga qaytish",
    },
    "escalated_closed": {
