...
1. Слова в фигурных скобках {вот_такие} — подстановки, их НЕ переводить
   и НЕ удалять. Имя подстановки неизменно: замена {when} на {date},
   удаление или дублирование — ошибка. Можно менять их место во фразе
   и аффиксы вокруг них.
...
3. Тон: вежливое «siz» (фамильярное «sen» — ошибка, исправляй), тёпло
   и просто. Избегай книжного, официально-государственного и
   академического узбекского — это переписка в мессенджере, не
   госуслуги. Кнопки (помечены btn_) должны остаться короткими.
